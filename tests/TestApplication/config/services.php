...
return static function (ContainerConfigurator $container) {
    ...
    $services->load('NormaUy\\Bundle\\NormaCMSBundle\\Tests\\TestApplication\\', '../src/*')
        ->exclude('../{Entity,Tests,Kernel.php}');

    $services->load('NormaUy\\Bundle\\NormaCMSBundle\\Tests\\TestApplication\\Controller\\', '../src/Controller/')
